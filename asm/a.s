...
# Dados dos vetores
    vec1:    .int 10, 2, 3, 4, 5    # Primeiro vetor
    vec2:    .int 10, 4, 3, 2, 1    # Segundo vetor
    result:  .space 20             # Vetor resultado (5 ints = 20 bytes)
    len:     .int 5                # Tamanho dos vetores
...
loop:
    ...
    mov eax, [vec1 + r12*4]  # Acesso indexado
    call int_to_string
    call print_cstring
